...
/*
 * OriginalMS - Nautilus Gachapon (NPC 9100110)
 */

var common = Array(2000004, 2000005, 2022020, 2044801, 2044901, 2040809, 1002080, 1050080, 1072080);
var normal = Array(2044803, 2044903, 2040810, 1082080, 1102080, 1482010, 1492010, 1322015);
var rare = Array(2049100, 1102082, 1482022, 1492022, 1322025);
...
function start() {
    if (cm.haveItem(5220000)) {
        cm.sendYesNo("I see you have a Gachapon Ticket! Would you like to try your luck at the Nautilus Gachapon?");
    } else {
        cm.sendSimple("Welcome to the Nautilus Gachapon! How can I help you?\r\n\r\n#L0#What is Gachapon?#l\r\n#L1#Where can I get Gachapon Tickets?#l");
    }
}
