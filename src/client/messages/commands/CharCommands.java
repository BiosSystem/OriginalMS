    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception,
        ...
        if (splitted[0].equals("!lowhp")) {
            ...
            if (c.getChannelServer().eventOn == false) {
                ...
                try {
                    c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(6, c.getSelectedChannel(), "[Event] The event has started in Channel (" + c.getSelectedChannel() + "). Use @event to participate.").getBytes());
                ...
                try {
                    c.getChannelServer().getWorldInterface().broadcastMessage(null, MaplePacketCreator.serverNotice(6, c.getSelectedChannel(), "[Event] The event has ended, thank you to everyone who participated.").getBytes());
                } catch (RemoteException e) {
                    c.getChannelServer().reconnectWorld();
                }
            }
            ...
            cserva.broadcastPacket(MaplePacketCreator.serverNotice(6, "Status of character <" + splitted[1] + ">"));
            ...
            player.dropMessage("BiosPoints: " + victim.getCSPoints(2));
            ...
            player.dropMessage(6, "Done, sent to " + splitted[1] + " the amount of " + splitted[2] + ".");
        } else if (splitted[0].equals("!leaderpoints")) {
            cserva.getPlayerStorage().getCharacterByName(splitted[1]).gainBiosPoints(Integer.parseInt(splitted[2]));
            player.dropMessage(6, "Done, sent to " + splitted[1] + " the amount of " + splitted[2] + ".");
            ...
            player.dropMessage(6, "Done, sent a gift to " + splitted[1] + ".");
            ...
            mc.dropMessage("[Mensagem] O total de " + players + " players have 0 HP.");
        }
