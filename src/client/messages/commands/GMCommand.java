...
public class GMCommand implements Command {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        if (splitted[0].equals("!notice")) {
            ...
            if (splitted.length > 1) {
                ...
                MaplePacket packet = MaplePacketCreator.serverNotice(6, "Boss rate has been changed to " + bossdrop + "x.");
                ChannelServer.getInstance(c.getSelectedChannel()).broadcastPacket(packet);
            } else {
            ...
            if (splitted.length > 1) {
                ...
                MaplePacket packet = MaplePacketCreator.serverNotice(6, "Experience rate has been changed to " + exp + "x.");
                ChannelServer.getInstance(c.getSelectedChannel()).broadcastPacket(packet);
            } else {
                mc.dropMessage("Syntax: !bossdroprate <number>");
            }
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
            ...
            new CommandDefinition("event", "none", "", 2),};
    }
}
