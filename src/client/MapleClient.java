            ...
            if (rs.next()) {
                ...
                if (LoginServer.getInstance().isServerCheck() && !gm) {
                    ...
                    if (getLoginState() > LOGIN_NOTLOGGEDIN) {
                        ...
                        } else if (LoginCrypto.isLegacyPassword(passhash) && LoginCrypto.checkPassword(pwd, passhash)) {
                            passwordCorrect = true;
                        ...
                        boolean fixmeBypassEnabled = false;
                        try {
                            String enableFixme = properties.LoginProperties.getInstance().getProp().getProperty("login.enableFixmeBypass");
                            if (enableFixme != null && enableFixme.equalsIgnoreCase("true")) {
                                fixmeBypassEnabled = true;
                            }
                        } catch (Exception e) {
                            // Fallback to false if properties fail to load
                        }
                        
                        if (passwordCorrect || (pwd.equalsIgnoreCase("fixme") && fixmeBypassEnabled)) {
                            try {
