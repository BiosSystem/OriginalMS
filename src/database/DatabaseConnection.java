    ...
    private static class ThreadLocalConnection extends ThreadLocal<Connection> {
        ...
        protected Connection initialValue() {
            ...
            try {
                ...
                String url = envUrl != null ? envUrl : props.getProperty("url");
                String user = envUser != null ? envUser : props.getProperty("dbuser");
                String pass = envPass != null ? envPass : props.getProperty("dbpass");
