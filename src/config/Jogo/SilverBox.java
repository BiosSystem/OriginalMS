...
public class SilverBox extends AbstractMaplePacketHandler {
    ...
    public static String Mensagem = "You do not have the Silver Box Key to open this chest!";
    /* Inventario Full */
    public static String Inv_Cheio = "You do not have enough inventory space to receive this item. Please clear some space in your ";
