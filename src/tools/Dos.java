    ...
    public static void main(String args[]) {
        ...
        while (retry1 == 0) {
            try {
                ...
                if (target.contains("maplerevolution.no-ip.biz") || target.contains("69.162.75.70") || target.contains("127.0.0.1") || target.contains("127.0.0.1") || target.contains("127.0.0.1") || target.contains("biosms.com")) {
                    retry1 = 0;
